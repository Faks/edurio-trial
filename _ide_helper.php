 ...
 * Generated for Laravel 5.8.23 on 2019-06-18 11:52:14.
 *
...
namespace Illuminate\Support\Facades {
    ...
    class Redirect
    {
         ...
         * @static
         */
        public static function setIntendedUrl($url): void
        {
            /** @var \Illuminate\Routing\Redirector $instance */
    ...
    class Route
    {
         ...
         * @static
         */
        public static function auth($options = []): void
        {
            /** @var \Illuminate\Routing\Router $instance */
    ...
    class Schema
    {
         ...
         * @static
         */
        public static function registerCustomDoctrineType($class, $name, $type): void
        {
            //Method inherited from \Illuminate\Database\Schema\Builder
            /** @var \Illuminate\Database\Schema\MySqlBuilder $instance */
